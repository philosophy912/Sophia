...
########################################################################################################################
    ...
    def swipt_find_text(self):
        """
        comment1
        """
        self.android_service.swipe_find_element(locator={"classname": "android.widget.TextView"}, swipe_element={"classname": "android.widget.ListView"}, text="龙卷风", swipe_percent=0.7)

    def clear_password(self):
        """
        comment2
        """
        self.android_service.clear_text(locator={"classname": "android.widget.ListView"}, timeout=3)

    def input_user_name(self):
        """
        comment3
        """
        self.android_service.input_text(locator={"classname": "android.widget.ListView"}, text="测试", timeout=3)
