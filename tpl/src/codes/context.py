...
if test_case_type == "仪表" or test_case_type == "智能座舱":
...
def vehicle_residual_mileage_acc_800():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_ACC_800__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_acc_400():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_ACC_400__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_acc_0():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_ACC_0__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_acc_850():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_ACC_850__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_ign_800():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_IGN_800__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_ign_400():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_IGN_400__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_ign_0():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_IGN_0__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_ign_850():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_IGN_850__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_off_800():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_OFF_800__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_off_400():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_OFF_400__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_off_0():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_OFF_0__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_residual_mileage_off_850():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_residual_mileage_OFF_850__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_p_acc():
    ...
    ActlGear_P_ACC
    """
    image_name = f"{android_screen_shot_path}/ActlGear_P_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_p_ign():
    ...
    ActlGear_P_IGN
    """
    image_name = f"{android_screen_shot_path}/ActlGear_P_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_p_off():
    ...
    ActlGear_P_OFF
    """
    image_name = f"{android_screen_shot_path}/ActlGear_P_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_r_ign():
    ...
    ActlGear_R_IGN
    """
    image_name = f"{android_screen_shot_path}/ActlGear_R_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_r_acc():
    ...
    ActlGear_R_ACC
    """
    image_name = f"{android_screen_shot_path}/ActlGear_R_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_n_ign():
    ...
    ActlGear_N_IGN
    """
    image_name = f"{android_screen_shot_path}/ActlGear_N_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_n_acc():
    ...
    ActlGear_N_ACC
    """
    image_name = f"{android_screen_shot_path}/ActlGear_N_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_d_ign():
    ...
    ActlGear_D_IGN
    """
    image_name = f"{android_screen_shot_path}/ActlGear_D_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_d_acc():
    ...
    ActlGear_D_ACC
    """
    image_name = f"{android_screen_shot_path}/ActlGear_D_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_d_ign1():
    ...
    ActlGear_D_IGN1
    """
    image_name = f"{android_screen_shot_path}/ActlGear_D_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_r_off():
    ...
    ActlGear_R_OFF
    """
    image_name = f"{android_screen_shot_path}/ActlGear_R_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgearr_r_ign1():
    ...
    ActlGearr_R_IGN1
    """
    image_name = f"{android_screen_shot_path}/ActlGearr_R_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_n_off():
    ...
    ActlGear_N_OFF
    """
    image_name = f"{android_screen_shot_path}/ActlGear_N_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgearr_r_ign2():
    ...
    ActlGearr_R_IGN2
    """
    image_name = f"{android_screen_shot_path}/ActlGearr_R_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_d_off():
    ...
    ActlGear_D_OFF
    """
    image_name = f"{android_screen_shot_path}/ActlGear_D_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgear_p_ign1():
    ...
    ActlGear_P_IGN1
    """
    image_name = f"{android_screen_shot_path}/ActlGear_P_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def actlgearr_n_ign1():
    ...
    ActlGearr_N_IGN1
    """
    image_name = f"{android_screen_shot_path}/ActlGearr_N_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_300kw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_300Kw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_0kw_ign():
    ...
    VhclActlPwr_0Kw_IGN
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_0Kw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_200nkw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_200NKw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_301kw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_301Kw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_160kw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_160Kw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_120nkw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_120NKw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_100kw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_100Kw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_100kw_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_100Kw_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vhclactlpwr_120kw_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VhclActlPwr_120Kw_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_speed_0_ign():
    ...
    Vehicle_Speed_0_IGN
    """
    image_name = f"{android_screen_shot_path}/Vehicle_Speed_0_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_speed_1_ign():
    ...
    Vehicle_Speed_1_IGN
    """
    image_name = f"{android_screen_shot_path}/Vehicle_Speed_1_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_speed_2_ign():
    ...
    Vehicle_Speed_2_IGN
    """
    image_name = f"{android_screen_shot_path}/Vehicle_Speed_2_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_speed_72_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_Speed_72_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_speed_100_inv_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_Speed_100_Inv_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vehicle_speed_301_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Vehicle_Speed_301_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_100_acc():
    ...
    Disp_Soc_100_ACC
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_100_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_4_acc():
    ...
    Disp_Soc_4_ACC
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_4_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_0_acc():
    ...
    Disp_Soc_0_ACC
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_0_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_101_acc():
    ...
    Disp_Soc_101_ACC
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_101_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_100_off():
    ...
    Disp_Soc_100_OFF
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_100_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_4_off():
    ...
    Disp_Soc_4_OFF
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_4_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_0_off():
    ...
    Disp_Soc_0_OFF
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_0_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_101_off():
    ...
    Disp_Soc_101_OFF
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_101_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_100_ign():
    ...
    Disp_Soc_100_IGN
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_100_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_4_ign():
    ...
    Disp_Soc_4_IGN
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_4_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_0_ign():
    ...
    Disp_Soc_0_IGN
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_0_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_101_ign():
    ...
    Disp_Soc_101_IGN
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_101_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def disp_soc_50_ign():
    ...
    Disp_Soc_50_IGN
    """
    image_name = f"{android_screen_shot_path}/Disp_Soc_50_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_off_yellowlight_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_OFF_YellowLight_Open_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_off_yellowlight_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_OFF_YellowLight_Close_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_ebd_err_redlight_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_EBD_Err_RedLight_Open_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_ebd_err_redlight_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_EBD_Err_RedLight_Close_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def left_turn_lamp_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Left_Turn_Lamp_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def left_turn_lamp_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Left_Turn_Lamp_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def left_turn_lamp_open_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Left_Turn_Lamp_OPEN_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def left_turn_lamp_close_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Left_Turn_Lamp_CLOSE_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def left_turn_lamp_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Left_Turn_Lamp_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def left_turn_lamp_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Left_Turn_Lamp_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def right_turn_lamp_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Right_Turn_Lamp_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def right_turn_lamp_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Right_Turn_Lamp_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def right_turn_lamp_open_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Right_Turn_Lamp_OPEN_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def right_turn_lamp_close_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Right_Turn_Lamp_CLOSE_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def right_turn_lamp_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Right_Turn_Lamp_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def right_turn_lamp_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Right_Turn_Lamp_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def warning_open_pwroff():
    ...
    Warning_OPEN_PwrOFF
    """
    image_name = f"{android_screen_shot_path}/Warning_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def warning_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Warning_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def position_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Position_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def position_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Position_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def high_beam_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/High_Beam_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def high_beam_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/High_Beam_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def low_beam_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Low_Beam_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def low_beam_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Low_Beam_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def refog_open_pwroff():
    ...
    ReFog_OPEN_PwrOFF
    """
    image_name = f"{android_screen_shot_path}/ReFog_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def refog_close_pwroff():
    ...
    ReFog_CLOSE_PwrOFF
    """
    image_name = f"{android_screen_shot_path}/ReFog_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def front_fog_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Front_Fog_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def front_fog_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Front_Fog_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def fl_doorajarsts_open():
    ...
    FL_DoorAjarSts_OPEN
    """
    image_name = f"{android_screen_shot_path}/FL_DoorAjarSts_OPEN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def fl_doorajarsts_close():
    ...
    """
    image_name = f"{android_screen_shot_path}/FL_DoorAjarSts_CLOSE__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def fr_doorajarsts_open():
    ...
    FR_DoorAjarSts_OPEN
    """
    image_name = f"{android_screen_shot_path}/FR_DoorAjarSts_OPEN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def fr_doorajarsts_close():
    ...
    """
    image_name = f"{android_screen_shot_path}/FR_DoorAjarSts_CLOSE__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rr_doorajarsts_open():
    ...
    RR_DoorAjarSts_OPEN
    """
    image_name = f"{android_screen_shot_path}/RR_DoorAjarSts_OPEN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rr_doorajarsts_close():
    ...
    """
    image_name = f"{android_screen_shot_path}/RR_DoorAjarSts_CLOSE__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rl_doorajarsts_open():
    ...
    RL_DoorAjarSts_OPEN
    """
    image_name = f"{android_screen_shot_path}/RL_DoorAjarSts_OPEN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rl_doorajarsts_close():
    ...
    """
    image_name = f"{android_screen_shot_path}/RL_DoorAjarSts_CLOSE__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def trunksts_open():
    ...
    TrunkSts_OPEN
    """
    image_name = f"{android_screen_shot_path}/TrunkSts_OPEN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def trunksts_close():
    ...
    TrunkSts_CLOSE
    """
    image_name = f"{android_screen_shot_path}/TrunkSts_CLOSE__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def hoodsts_open():
    ...
    HoodSts_OPEN
    """
    image_name = f"{android_screen_shot_path}/HoodSts_OPEN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def hoodsts_close():
    ...
    HoodSts_CLOSE
    """
    image_name = f"{android_screen_shot_path}/HoodSts_CLOSE__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def parking_status():
    ...
    Parking_Status
    """
    image_name = f"{android_screen_shot_path}/Parking_Status__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def driving_status():
    ...
    Driving_Status
    """
    image_name = f"{android_screen_shot_path}/Driving_Status__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def charging_status():
    ...
    Charging_Status
    """
    image_name = f"{android_screen_shot_path}/Charging_Status__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def charging_parking_status():
    ...
    """
    image_name = f"{android_screen_shot_path}/CHARGING_Parking_Status__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def tpmssystem_statusabnormal_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/TPMSSystem_StatusAbnormal_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def tpmssystem_statusnormal_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/TPMSSystem_StatusNormal_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def tire_right_frontpressure_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Tire_Right_FrontPressure_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def tire_left_frontpressure_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Tire_Left_FrontPressure_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def tire_right_fronttemperature_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Tire_Right_FrontTemperature_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def airbag_light_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/AirBag_Light_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def airbag_light_blink_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/AirBag_Light_Blink_PwrIGN__"
    for i in range(5):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def airbag_light_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/AirBag_Light_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frontbelt_out_ign_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/FrontBelt_OUT_IGN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftfrontbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftFrontBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rightfrontbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/RightFrontBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frontbelt_in_ign_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/FrontBelt_IN_IGN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftrearbelt_in_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftRearBelt_IN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftctrrearbelt_in_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftCtrRearBelt_IN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftctrrightrearbelt_in_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftCtrRightRearBelt_IN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftrearbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftRearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftctrrearbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftCtrRearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rearbelt_out_pwrign():
    ...
    RearBelt_OUT_PwrIGN
    """
    image_name = f"{android_screen_shot_path}/RearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ctrrearbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/CtrRearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def leftrightrearbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/LeftRightRearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ctrrightrearbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/CtrRightRearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rightrearbelt_out_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/RightRearBelt_OUT_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rearbelt_pwrign():
    ...
    RearBelt_PwrIGN
    """
    image_name = f"{android_screen_shot_path}/RearBelt_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def rearbelt_pwrign1():
    ...
    RearBelt_PwrIGN1
    """
    image_name = f"{android_screen_shot_path}/RearBelt_PwrIGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_abs_yellowlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_ABS_YellowLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_abs_yellowlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_ABS_YellowLight_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_err_yellowlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_Err_YellowLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_err_yellowlight_bink_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_Err_YellowLight_Bink_PwrIGN__"
    for i in range(5):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_err_yellowlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_Err_YellowLight_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def autohold_greenlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/AutoHold_GreenLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def autohold_greenlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/AutoHold_GreenLight_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_warn_yellowlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_WARN_YellowLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_warn_yellowlight_blinking_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_WARN_YellowLight_Blinking_PwrIGN__"
    for i in range(5):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def esp_warn_yellowlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/ESP_WARN_YellowLight_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_blinking_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_Blinking_PwrOFF__"
    for i in range(5):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_close_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_CLOSE_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_blinking_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_Blinking_PwrIGN__"
    for i in range(5):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_open_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_OPEN_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_blinking_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_Blinking_PwrACC__"
    for i in range(5):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def epb_redlight_close_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPB_RedLight_CLOSE_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def eps_hdc_greenlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPS_HDC_GreenLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def eps_hdc_greenlight_blinking_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPS_HDC_GreenLight_Blinking_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def eps_hdc_greenlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPS_HDC_GreenLight_Close_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def eps_redlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPS_RedLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def eps_yellowlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/EPS_YellowLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def eps_light_close_ign():
    ...
    EPS_LIGHT_CLOSE_IGN
    """
    image_name = f"{android_screen_shot_path}/EPS_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def battcplowwarn_yellowlight_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/BattCpLowWarn_YellowLight_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def battcplowwarn_yellowlight_close_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/BattCpLowWarn_YellowLight_CLOSE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptovrtmp_light_open1_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PTOvrTmp_LIGHT_OPEN1_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptovrtmp_light_open2_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PTOvrTmp_LIGHT_OPEN2_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptovrtmp_light_open3_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PTOvrTmp_LIGHT_OPEN3_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptovrtmp_light_open4_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PTOvrTmp_LIGHT_OPEN4_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptovrtmp_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PTOvrTmp_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed0_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed0_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_off_speed20_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_OFF_Speed20_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed0_ign2():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed0_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed50_ign3():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed50_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed0_ign4():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed0_IGN4__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed0_ign_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed0_IGN_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed0__pwroff_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed0__PwrOFF_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ready_on_speed0_pwrign_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ready_ON_Speed0_PwrIGN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def b12vpower_charging_sts_light_open1_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/B12VPOWER_CHARGING_Sts_LIGHT_OPEN1_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def b12vpower_charging_sts_light_open2_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/B12VPOWER_CHARGING_Sts_LIGHT_OPEN2_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def b12vpower_charging_sts_light_close_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/B12VPOWER_CHARGING_Sts_LIGHT_CLOSE_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def b12vpower_charging_sts_light_open1_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/B12VPOWER_CHARGING_Sts_LIGHT_OPEN1_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def b12vpower_charging_sts_light_open2_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/B12VPOWER_CHARGING_Sts_LIGHT_OPEN2_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def b12vpower_charging_sts_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/B12VPOWER_CHARGING_Sts_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptfltindcr_sts_light_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PtFltIndcr_Sts_LIGHT_OPEN_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_ptfltindcr_sts_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PtFltIndcr_Sts_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgstsindcr_light_open_off():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgStsIndcr_LIGHT_OPEN_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgstsindcr_light_close_off():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgStsIndcr_LIGHT_CLOSE_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgstsindcr_light_open_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgStsIndcr_LIGHT_OPEN_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgstsindcr_light_close_acc():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgStsIndcr_LIGHT_CLOSE_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgstsindcr_light_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgStsIndcr_LIGHT_OPEN_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgstsindcr_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgStsIndcr_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgconnectindcr_light_open_pwroff():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgConnectIndcr_LIGHT_OPEN_PwrOFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgconnectindcr_light_close_pwrofff():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgConnectIndcr_LIGHT_CLOSE_PwrOFFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgconnectindcr_light_open_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgConnectIndcr_LIGHT_OPEN_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgconnectindcr_light_close_pwracc():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgConnectIndcr_LIGHT_CLOSE_PwrACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgconnectindcr_light_open_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgConnectIndcr_LIGHT_OPEN_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_chrgconnectindcr_light_closle_pwrign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_ChrgConnectIndcr_LIGHT_CLOSLE_PwrIGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mcu_motoverspdwarn_frnt_light_open1_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/MCU_MotOverSpdWarn_Frnt_LIGHT_OPEN1_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mcu_motoverspdwarn_frnt_light_open2_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/MCU_MotOverSpdWarn_Frnt_LIGHT_OPEN2_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mcu_motoverspdwarn_frnt_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/MCU_MotOverSpdWarn_Frnt_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_turtlelampon_light_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_TurtleLampOn_LIGHT_OPEN_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_turtlelampon_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_TurtleLampOn_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_pwrbatthvcutoffindcr_light_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PwrBattHVCutOffIndcr_LIGHT_OPEN_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_pwrbatthvcutoffindcr_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PwrBattHVCutOffIndcr_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_pwrbattfltindcr_light_open_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PwrBattFltIndcr_LIGHT_OPEN_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def vcu_pwrbattfltindcr_light_close_ign():
    ...
    """
    image_name = f"{android_screen_shot_path}/VCU_PwrBattFltIndcr_LIGHT_CLOSE_IGN__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_standby_ign1():
    ...
    CCMod_Standby_IGN1
    """
    image_name = f"{android_screen_shot_path}/CCMod_Standby_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_standby_ign2():
    ...
    CCMod_Standby_IGN2
    """
    image_name = f"{android_screen_shot_path}/CCMod_Standby_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_active_ign3():
    ...
    CCMod_Active_IGN3
    """
    image_name = f"{android_screen_shot_path}/CCMod_Active_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_active_off():
    ...
    CCMod_Active_OFF
    """
    image_name = f"{android_screen_shot_path}/CCMod_Active_OFF__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_active_ign4():
    ...
    CCMod_Active_IGN4
    """
    image_name = f"{android_screen_shot_path}/CCMod_Active_IGN4__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_cancel_ign5():
    ...
    CCMod_Cancel_IGN5
    """
    image_name = f"{android_screen_shot_path}/CCMod_Cancel_IGN5__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_cancel_ign6():
    ...
    CCMod_Cancel_IGN6
    """
    image_name = f"{android_screen_shot_path}/CCMod_Cancel_IGN6__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ccmod_standby_acc():
    ...
    CCMod_Standby_ACC
    """
    image_name = f"{android_screen_shot_path}/CCMod_Standby_ACC__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_standby_ign2():
    ...
    ACCMod_StandBy_IGN2
    """
    image_name = f"{android_screen_shot_path}/ACCMod_StandBy_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_passive():
    ...
    ACCMod_Passive
    """
    image_name = f"{android_screen_shot_path}/ACCMod_Passive__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_active_ign3():
    ...
    ACCMod_Active_IGN3
    """
    image_name = f"{android_screen_shot_path}/ACCMod_Active_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_override_ign4():
    ...
    """
    image_name = f"{android_screen_shot_path}/ACCMod_Override_IGN4__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_brakeonly_ign5():
    ...
    """
    image_name = f"{android_screen_shot_path}/ACCMod_BrakeOnly_IGN5__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_brakeonly_dark():
    ...
    """
    image_name = f"{android_screen_shot_path}/ACCMod_BrakeOnly_Dark__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_brakeonly_ign6():
    ...
    """
    image_name = f"{android_screen_shot_path}/ACCMod_BrakeOnly_IGN6__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def accmod_failure_dark():
    ...
    ACCMod_Failure_Dark
    """
    image_name = f"{android_screen_shot_path}/ACCMod_Failure_Dark__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_greenlight_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_GreenLight_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_greenlight_ign2():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_GreenLight_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_greenlight_ign3():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_GreenLight_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_redlight_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_RedLight_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_redlight_ign2():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_RedLight_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_redlight_ign3():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_RedLight_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_aeb_light_dark():
    ...
    FRM_AEB_Light_Dark
    """
    image_name = f"{android_screen_shot_path}/FRM_AEB_Light_Dark__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mpc_ldw_standbylight_ign2():
    ...
    """
    image_name = f"{android_screen_shot_path}/MPC_LDW_StandbyLight_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mpc_ldw_activelight_ign3():
    ...
    """
    image_name = f"{android_screen_shot_path}/MPC_LDW_ActiveLight_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mpc_ldw_faultlight_ign4():
    ...
    """
    image_name = f"{android_screen_shot_path}/MPC_LDW_FaultLight_IGN4__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mpc_ldw_camerablocklight_ign5():
    ...
    """
    image_name = f"{android_screen_shot_path}/MPC_LDW_CamerablockLight_IGN5__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def mpc_ldw_offlight_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/MPC_LDW_OffLight_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_tja__standbylight_ign2():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_TJA__StandbyLight_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_tja__activelight_ign3():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_TJA__ActiveLight_IGN3__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_tja__faultlight_ign4():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_TJA__FaultLight_IGN4__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def frm_tja_passivelight_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/FRM_TJA_PassiveLight_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ai_hibeam_greenlight_ign1():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ai_HiBeam_GreenLight_IGN1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ai_hibeam_greenlight_off1():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ai_HiBeam_GreenLight_OFF1__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ai_hibeam_bluelight_ign2():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ai_HiBeam_BlueLight_IGN2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
...
def ai_hibeam_bluelight_off2():
    ...
    """
    image_name = f"{android_screen_shot_path}/Ai_HiBeam_BlueLight_OFF2__"
    for i in range(1):
        android_service.adb.screen_shot(remote_file=f"{image_name}{i + 1}", display_id=1, device_id=android_device_id)
    ####################################################################################################################
    #                                                                                                                  #
