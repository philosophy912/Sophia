...
def vehicle_residual_mileage_acc_800():
    ...
    hypervisor.screen_shot(image_name=image_name, count=1, interval_time=interval_time)
...
def airbag_light_blink_pwrign():
    ...
    hypervisor.screen_shot(image_name=image_name, count=5, interval_time=interval_time)
